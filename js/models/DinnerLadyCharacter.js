class DinnerLadyCharacter {
    ...
    constructor() {
        ...
        // Materials
        const pinkMaterial = new THREE.MeshPhongMaterial({ color: 0xFF69B4 }); // Pink for head and legs
        const whiteMaterial = new THREE.MeshPhongMaterial({ color: 0xFFFFFF }); // White for torso and arms
        
        // Head (2x2x2 units)
        const headGeometry = new THREE.BoxGeometry(1, 1, 1);
        this.#head = new THREE.Mesh(headGeometry, pinkMaterial);
        this.#head.position.y = 3.5; // Position on top of torso
        this.#head.castShadow = true;
        
        // Torso (2x5x1 units)
        const torsoGeometry = new THREE.BoxGeometry(1, 2.5, 0.5);
        this.#torso = new THREE.Mesh(torsoGeometry, whiteMaterial);
        ...
        this.#rightArm = new THREE.Mesh(armGeometry.clone(), whiteMaterial);
        ...
        this.#leftLeg = new THREE.Mesh(legGeometry, pinkMaterial);
        this.#rightLeg = new THREE.Mesh(legGeometry.clone(), pinkMaterial);
